    ...
    <div className={`flex flex-col items-center w-full max-w-4xl mx-auto px-4 ${!originalSrc ? "flex-1 justify-center py-12" : "py-8"}`}>
      ...
      {!originalSrc && (
        ...
        >
          ...
          <p className="text-gray-500 text-sm sm:text-base text-center mb-10">AI가 자동으로 배경을 감지하여 제거합니다</p>
        ...
        <>
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              <div className="px-4 py-3 bg-gray-50 border-b border-gray-200 text-xs font-bold text-gray-700">📷 원본 이미지</div>
            ...
            {/* 결과 */}
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              <div className="px-4 py-3 bg-gray-50 border-b border-gray-200 text-xs font-bold text-gray-700">✂️ 누끼 결과</div>
              <div className="p-4 flex items-center justify-center min-h-[350px] relative"
                ...
                {isProcessing ? (
                  ...
                  <p className="text-gray-500 text-xs">{progress || "처리 대기 중..."}</p>
                )}
              </div>
            </div>
          </div>
